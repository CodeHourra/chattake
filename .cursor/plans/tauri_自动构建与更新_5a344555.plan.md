...
`[tauri.conf.json](apps/desktop/src-tauri/tauri.conf.json)` 已把 `chattake-sidecar` 打进 `bundle.resources`。**完整应用更新**时，新安装包会带上新 sidecar；只要每次发版前 sidecar 构建进同一 pipeline，无需单独更新 sidecar。
